...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  ...
  <div class="w3-display-middle" style="width:65%">
    <div class="w3-bar w3-black">
      ...
      <button class="w3-bar-item w3-button tablink" onclick="openLink(event, 'buyer');"><i class="fa fa-car w3-margin-right"></i>Buy new House</button>
    ...
    <div id="investor" class="w3-container w3-white w3-padding-16 myLink">
      ...
      <div class="w3-row-padding" style="margin:0 -16px;">
        ...
        <div class="w3-half">
          ...
          <input class="w3-input w3-border" type="text" placeholder="Seattle, Tacoma, etc">
        </div>
      </div>
      <p><button class="w3-button w3-dark-grey" href="investor.php">Search investment opportunities </button></p>
    </div>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <p>Practical first house for a young family in Tacoma metro.</p>
        <button class="w3-button w3-margin-bottom">Get Report</button>
      </div>
    </div>
  </div>
